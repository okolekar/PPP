...
#===========================================================================================================================#
    def get_liq_param(self,mesh,ds_dt,ele_no):
        ...
        self.Nl = np.array([[(1/(3*(mm.n)))*ds_dt+2/(mesh.J*2)              ,   -((3*(ele_no)-2)/(6*(mm.n)))*ds_dt-1/(mesh.J*2)],
...
#===========================================================================================================================#
    def get_sol_param(self,mesh,ele_no,ds_dt):
        ...
        self.Ns = np.array([[-(ds_dt/(mm.m*3))+2/(2*mesh.J)                  ,   -((3*mm.m-3*(ele_no) + 2)*ds_dt/(6*mm.m))-(1/mesh.J*2)],
